...
// Camo set
#define CAMO_UNIFORM "OPTRE_UNSC_Army_Uniform_DES"
#define CAMO_VEST "OPTRE_UNSC_M52A_Armor_Rifleman_DES"
#define CAMO_BACKPACK "OPTRE_ILCS_Rucksack_Black"
#define CAMO_HEADGEAR "OPTRE_UNSC_CH252_Helmet_Vacuum_DES"
// Rifle
#define RIFLE "OPTRE_MA32"
#define RIFLE_MAG "OPTRE_32Rnd_762x51_Mag:10"
#define RIFLE_ATTACHMENTS "OPTRE_BR55HB_Scope"
...
class sm: Fic_Soldier_Carbine {// Medic
  headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_DES_MED"};
...
class vicc: Fic_Soldier_Carbine {// Crew
  vest[] = {"OPTRE_UNSC_M52A_Armor2_DES"};
