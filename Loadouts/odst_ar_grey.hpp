...
// Camo set
#define CAMO_UNIFORM "OPTRE_UNSC_ODST_Uniform"
#define CAMO_VEST "OPTRE_UNSC_M52A_Armor_Rifleman_URB"
#define CAMO_BACKPACK "OPTRE_ILCS_Rucksack_Black"
#define CAMO_HEADGEAR "OPTRE_UNSC_CH252_Helmet_Vacuum_URB"
// Rifle
...
class sm: Fic_Soldier_Carbine {// Medic
  headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_URB_MED"};
...
class vicc: Fic_Soldier_Carbine {// Crew
  vest[] = {"OPTRE_UNSC_M52A_Armor2_URB"};
